...
line.add_yaxis('PM2.5值',v1,markline_opts=opts.MarkLineOpts(data=[opts.MarkLineItem(type_='average')]),
...
line.set_global_opts(title_opts=opts.TitleOpts(title='2018年北京PM2.5全年走势图',pos_left='center',pos_top='18'))
